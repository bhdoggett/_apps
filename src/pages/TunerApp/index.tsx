    ...
    <div className={styles.content}>
      <div className={styles.controls}>
        <button
          className={[
            styles.modeBtn,
            mode === "listen" ? styles.modeBtnActive : "",
          ]
            .filter(Boolean)
            .join(" ")}
          onClick={() => {
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M2.5 7 C2.5 11 11.5 11 11.5 7"
              stroke="currentColor"
              strokeWidth="1.2"
              fill="none"
              strokeLinecap="round"
        ...
        <button
          className={[
            styles.modeBtn,
            mode === "play" ? styles.modeBtnActive : "",
          ]
            .filter(Boolean)
            .join(" ")}
          onClick={() => {
        ...
        >
          ...
          >
            ...
            <path
              d="M8.5 4.5 C10.2 5.5 10.2 8.5 8.5 9.5"
              stroke="currentColor"
              strokeWidth="1.2"
              fill="none"
              strokeLinecap="round"
            />
            <path
              d="M10.2 3 C12.8 4.5 12.8 9.5 10.2 11"
              stroke="currentColor"
              strokeWidth="1.2"
              fill="none"
              strokeLinecap="round"
          ...
          {status === "active" && (
            <>
              <div className={styles.noteDisplay}>
                <span
                  className={[styles.noteName, inTune ? styles.inTune : ""]
                    .filter(Boolean)
                    .join(" ")}
                >
                  {note ?? "—"}
        ...
        <>
          <div className={styles.notePicker}>
            <button
              ...
              onClick={() => changeNote(selectedMidi - 1)}
            >
              −
            </button>
            <span
